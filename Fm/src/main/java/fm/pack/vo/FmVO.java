...
public class FmVO {
	...
	public FmVO(String current_seq, String title, String content, String next_seq, String writer, String user_id) {
		super();
	...
	public FmVO(int seq, int write_seq, String current_seq, String title, String content, int read_count,
			String next_seq, String write_date, String writer, String user_id) {
		super();
		this.seq = seq;
	...
	public void setCurrent_seq(String i) {
		this.current_seq = i;
	}
